...
import com.zx.landdisaster.module.disaster.func.adapter.ReportStatisAreaManageDetailAdapter
import com.zx.landdisaster.module.disaster.mvp.contract.ReportPianQuDetailContract
import com.zx.landdisaster.module.disaster.mvp.model.ReportPianQuDetailModel
import com.zx.landdisaster.module.disaster.mvp.presenter.ReportPianQuDetailPresenter
import com.zx.zxutils.util.ZXTimeUtil
import com.zx.zxutils.views.SwipeRecylerView.ZXSRListener
import kotlinx.android.synthetic.main.activity_report_pian_qu_detail.*
 ...
 * 功能：片区周报-详情
 */
class ReportPianQuDetailActivity : BaseActivity<ReportPianQuDetailPresenter, ReportPianQuDetailModel>(), ReportPianQuDetailContract.View {
    val dataBeans = arrayListOf<ReportPianQuDetailBean>()
    private val adapter = ReportStatisAreaManageDetailAdapter(dataBeans)
    var pageNo = 1
    ...
    companion object {
         ...
         * 启动器
         */
        fun startAction(activity: Activity, isFinish: Boolean, areaCode: String, title: String, sTime: String, eTime: String) {
            val intent = Intent(activity, ReportPianQuDetailActivity::class.java)
    ...
    override fun getLayoutId(): Int {
        return R.layout.activity_report_pian_qu_detail
    }
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        tbv_title.setMidText("片区周报-$title")
        ...
        rv_info_list.setLayoutManager(LinearLayoutManager(this))
                ...
                .autoLoadMore()
                .setSRListener(object : ZXSRListener<ReportPianQuDetailBean> {
                    override fun onItemLongClick(item: ReportPianQuDetailBean?, position: Int) {
                    ...
                    override fun onItemClick(item: ReportPianQuDetailBean?, position: Int) {
                    }
    ...
    fun loadData(refresh: Boolean = false) {
        ...
        mPresenter.pageAreaManagerreportrateDetail(ApiParamUtil.getReportstatis(pageNo = pageNo, pageSize = pageSize, areacode = areacode, startTime = startTime, endTime = endTime))
    }
    ...
    override fun onPageAreaManagerreportrateDetailResult(list: NormalList<ReportPianQuDetailBean>?) {
        if (list != null) {
