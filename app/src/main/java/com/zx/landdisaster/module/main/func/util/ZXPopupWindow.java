...
public class ZXPopupWindow  extends PopupWindow {

    private BubbleRelativeLayout bubbleView;
    private Context context;

    public ZXPopupWindow(Context context) {
    ...
    public ZXPopupWindow setBubbleView(int resourceId) {
        View bubbleView = LayoutInflater.from(context).inflate(resourceId, null);
        setBubbleView(bubbleView);
        return this;
    }

    public ZXPopupWindow setBubbleView(View view) {
